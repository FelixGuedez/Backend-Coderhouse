...
app.get('/info', (req, res) => {
    ...
    res.render('info.hbs', { arg_Entrada, vOs, vNode, memoryOs, pathEjec, idProcess, carpetaProy })
...
/* ---------------------- Servidor ----------------------*/
let options = { default: { p: '8083' } }
// const PORT = process.env.PORT;
const PORT = minimist(argv, options)
console.log(PORT.p)
const server = httpServer.listen(PORT.p, () => {
    console.log(`Servidor escuchando en puerto http://localhost:${PORT.p}`);
})
